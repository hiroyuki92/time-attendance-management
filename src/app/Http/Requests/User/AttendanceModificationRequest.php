...
class AttendanceModificationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'requested_clock_out' => 'required|after:requested_clock_in',
            'break_times.*.requested_break_start' => 'after_or_equal:requested_clock_in|before_or_equal:requested_clock_out',
            'break_times.*.requested_break_end' => 'required|date_format:H:i|after_or_equal:requested_break_start|before_or_equal:requested_clock_out|after_or_equal:requested_clock_in',
