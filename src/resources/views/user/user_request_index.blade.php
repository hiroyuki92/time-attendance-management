...
<main class="container center">
    ...
    <div class="tabs">
        <a href="{{ url('stamp_correction_request/list?tab=pending') }}" class="tab {{ $tab === 'pending' ? 'active' : '' }}">承認待ち</a>
        <a href="{{ url('stamp_correction_request/list?tab=approved') }}" class="tab {{ $tab === 'approved' ? 'active' : '' }}">承認済み</a>
    </div>
